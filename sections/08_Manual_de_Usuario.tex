...
La plataforma cuenta con una interfaz web reactiva diseñada para abstraer la complejidad de las consultas a la base de datos de grafos. Al acceder al sistema (por defecto en \texttt{http://localhost:8501}), el operario logístico encontrará un diseño limpio cuyo elemento principal de navegación es un \textbf{menú lateral}. Este menú permite alternar entre las tres áreas funcionales del sistema: \textbf{Inventario}, \textbf{Rutas} y \textbf{Administración}.
